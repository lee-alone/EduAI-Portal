...
- 分析要具体、深入、有针对性
- 使用HTML格式，但不要分段标题
- **重要**：完成所有学生个人评价后，必须添加分隔标识符：<!-- STUDENT_ANALYSIS_END -->`,

            // 学生分析示例
            studentAnalysisExample: (useAnnotations = false) => {
                const example = `张三同学这段时间表现积极，课堂参与度高，在数学和物理方面表现突出。他能够主动举手发言，思维敏捷，解题思路清晰。建议继续保持这种学习热情，可以尝试挑战更有难度的题目。需要注意的是，他在某些基础概念上还需要加强练习，建议多做一些基础题巩固。`;
...
**重要提醒：完成所有学生个人评价后，必须添加分隔标识符：<!-- STUDENT_ANALYSIS_END -->**
